...
import { StyledBody } from "./SaveOptionModal.styled";
...
const SaveOptionModal = (props) => {
    ...
    const AddOptionContents = (optionName, value) => {
    ...
    const handleOptionSubmit = async (e) => {
        ...
        axios.post("http://127.0.0.1:5001/api/admin/update_Country_Options", {
    ...
    const pickDefaultValue = (option) => {
        const str_values = optionNames[`${option}`];
        const array_values = str_values.split(",");
        const result = array_values.map(value => {
            return({
                        ...
                        <div id="select_option">
                            {
                                ...
                                return(
                                    ...
                                    onChange={(e, value) => AddOptionContents(optionName, value)}
